...
const static lv_i18n_phrase_t en_singulars[] = {
    ...
    {"duress_pin_fail_desc", "Please try again."},
    {"duress_pin_fail_title", "Failed to Set Duress PIN"},
    {"duress_pin_removed_desc", "The duress PIN has been cleared from this device."},
    {"duress_pin_removed_title", "Duress PIN Removed"},
    {"duress_pin_repeat_desc", "Confirm the duress PIN you entered."},
    {"duress_pin_repeat_title", "Re-Enter Duress PIN"},
    {"duress_pin_set_desc", "This PIN will trigger an emergency device wipe when entered at the lock screen."},
    {"duress_pin_set_title", "Set Duress PIN"},
    {"duress_pin_success_desc", "Entering this PIN at the lock screen will wipe the device."},
    {"duress_pin_success_title", "Duress PIN Set"},
    {"duress_pin_title", "Duress PIN"},
    {"duress_pin_verified_desc", "The PIN you entered matches your duress PIN."},
    {"duress_pin_verified_title", "Duress PIN Verified"},
    {"duress_pin_verify_desc", "Enter your duress PIN to confirm you remember it."},
    {"duress_pin_verify_title", "Verify Duress PIN"},
...
const static lv_i18n_phrase_t de_singulars[] = {
    ...
    {"duress_pin_fail_desc", "Bitte versuchen Sie es erneut."},
    {"duress_pin_fail_title", "Notfall-PIN konnte nicht gesetzt werden"},
    {"duress_pin_removed_desc", "Die Notfall-PIN wurde von diesem Gerät gelöscht."},
    {"duress_pin_removed_title", "Notfall-PIN Entfernt"},
    {"duress_pin_repeat_desc", "Bestätigen Sie die eingegebene Notfall-PIN."},
    {"duress_pin_repeat_title", "Notfall-PIN erneut eingeben"},
    {"duress_pin_set_desc", "Diese PIN löst eine Notfall-Löschung des Geräts aus wenn sie auf dem Sperrbildschirm eingegeben wird."},
    {"duress_pin_set_title", "Notfall-PIN festlegen"},
    {"duress_pin_success_desc", "Die Eingabe dieser PIN auf dem Sperrbildschirm löscht das Gerät."},
    {"duress_pin_success_title", "Notfall-PIN Gesetzt"},
    {"duress_pin_title", "Notfall-PIN"},
    {"duress_pin_verified_desc", "Die eingegebene PIN stimmt mit Ihrer Notfall-PIN überein."},
    {"duress_pin_verified_title", "Notfall-PIN Bestätigt"},
    {"duress_pin_verify_desc", "Geben Sie Ihre Notfall-PIN ein um zu bestätigen dass Sie sich daran erinnern."},
    {"duress_pin_verify_title", "Notfall-PIN überprüfen"},
...
const static lv_i18n_phrase_t es_singulars[] = {
    ...
    {"duress_pin_change", "Cambiar PIN de Coacción"},
    {"duress_pin_fail_desc", "Por favor inténtalo de nuevo."},
    {"duress_pin_fail_title", "Error al configurar el PIN de Coacción"},
    {"duress_pin_removed_desc", "El PIN de coacción ha sido eliminado de este dispositivo."},
    {"duress_pin_removed_title", "PIN de Coacción Eliminado"},
    {"duress_pin_repeat_desc", "Confirme el PIN de coacción que ingresó."},
    {"duress_pin_repeat_title", "Vuelva a ingresar el PIN de Coacción"},
    {"duress_pin_set_desc", "Este PIN activará un borrado de emergencia del dispositivo al ingresarlo en la pantalla de bloqueo."},
    {"duress_pin_set_title", "Establecer PIN de Coacción"},
    {"duress_pin_success_desc", "Ingresar este PIN en la pantalla de bloqueo borrará el dispositivo."},
    {"duress_pin_success_title", "PIN de Coacción Configurado"},
    {"duress_pin_title", "PIN de Coacción"},
    {"duress_pin_verified_desc", "El PIN que ingresó coincide con su PIN de coacción."},
    {"duress_pin_verified_title", "PIN de Coacción Verificado"},
    {"duress_pin_verify_desc", "Ingrese su PIN de coacción para confirmar que lo recuerda."},
    {"duress_pin_verify_title", "Verificar PIN de Coacción"},
...
const static lv_i18n_phrase_t ja_singulars[] = {
    ...
    {"duress_pin_change", "脅迫PINを変更"},
    {"duress_pin_fail_desc", "もう一度お試しください."},
    {"duress_pin_fail_title", "脅迫PINの設定に失敗しました"},
    {"duress_pin_removed_desc", "脅迫PINがこのデバイスから削除されました."},
    {"duress_pin_removed_title", "脅迫PINが削除されました"},
    {"duress_pin_repeat_desc", "入力した脅迫PINを確認してください."},
    {"duress_pin_repeat_title", "脅迫PINを再入力"},
    {"duress_pin_set_desc", "このPINをロック画面で入力すると緊急デバイス消去が実行されます."},
    {"duress_pin_set_title", "脅迫PINを設定"},
    {"duress_pin_success_desc", "ロック画面でこのPINを入力するとデバイスが消去されます."},
    {"duress_pin_success_title", "脅迫PINが設定されました"},
    {"duress_pin_title", "脅迫PIN"},
    {"duress_pin_verified_desc", "入力したPINは脅迫PINと一致します."},
    {"duress_pin_verified_title", "脅迫PINが確認されました"},
    {"duress_pin_verify_desc", "脅迫PINを入力して覚えていることを確認してください."},
    {"duress_pin_verify_title", "脅迫PINを確認"},
...
const static lv_i18n_phrase_t ko_singulars[] = {
    ...
    {"duress_pin_change", "위험 PIN 변경"},
    {"duress_pin_fail_desc", "다시 시도해 주세요."},
    {"duress_pin_fail_title", "위험 PIN 설정 실패"},
    {"duress_pin_removed_desc", "이 장치에서 위험 PIN이 삭제되었습니다."},
    {"duress_pin_removed_title", "위험 PIN 제거됨"},
    {"duress_pin_repeat_desc", "입력한 위험 PIN을 확인하세요."},
    {"duress_pin_repeat_title", "위험 PIN 다시 입력"},
    {"duress_pin_set_desc", "이 PIN을 잠금 화면에서 입력하면 긴급 장치 초기화가 실행됩니다."},
    {"duress_pin_set_title", "위험 PIN 설정"},
    {"duress_pin_success_desc", "잠금 화면에서 이 PIN을 입력하면 장치가 초기화됩니다."},
    {"duress_pin_success_title", "위험 PIN 설정됨"},
    {"duress_pin_title", "위험 PIN"},
    {"duress_pin_verified_desc", "입력한 PIN이 위험 PIN과 일치합니다."},
    {"duress_pin_verified_title", "위험 PIN 확인됨"},
    {"duress_pin_verify_desc", "위험 PIN을 입력하여 기억하는지 확인하세요."},
    {"duress_pin_verify_title", "위험 PIN 확인"},
...
const static lv_i18n_phrase_t ru_singulars[] = {
    ...
    {"duress_pin_change", "Изменить тревожный PIN-код"},
    {"duress_pin_fail_desc", "Пожалуйста попробуйте снова."},
    {"duress_pin_fail_title", "Не удалось установить тревожный PIN-код"},
    {"duress_pin_removed_desc", "Тревожный PIN-код был удален с этого устройства."},
    {"duress_pin_removed_title", "Тревожный PIN-код удален"},
    {"duress_pin_repeat_desc", "Подтвердите введенный тревожный PIN-код."},
    {"duress_pin_repeat_title", "Подтвердите тревожный PIN-код"},
    {"duress_pin_set_desc", "Этот PIN-код запустит экстренную очистку устройства при вводе на экране блокировки."},
    {"duress_pin_set_title", "Установить тревожный PIN-код"},
    {"duress_pin_success_desc", "Ввод этого PIN-кода на экране блокировки приведет к очистке устройства."},
    {"duress_pin_success_title", "Тревожный PIN-код установлен"},
    {"duress_pin_title", "Тревожный PIN-код"},
    {"duress_pin_verified_desc", "Введенный PIN-код совпадает с вашим тревожным PIN-кодом."},
    {"duress_pin_verified_title", "Тревожный PIN-код подтвержден"},
    {"duress_pin_verify_desc", "Введите тревожный PIN-код чтобы убедиться что вы его помните."},
    {"duress_pin_verify_title", "Проверить тревожный PIN-код"},
...
const static lv_i18n_phrase_t zh_cn_singulars[] = {
    ...
    {"duress_pin_change", "更改胁迫 PIN"},
    {"duress_pin_fail_desc", "请重试."},
    {"duress_pin_fail_title", "胁迫 PIN 设置失败"},
    {"duress_pin_removed_desc", "胁迫 PIN 已从此设备中清除."},
    {"duress_pin_removed_title", "胁迫 PIN 已移除"},
    {"duress_pin_repeat_desc", "确认您输入的胁迫 PIN."},
    {"duress_pin_repeat_title", "重新输入胁迫 PIN"},
    {"duress_pin_set_desc", "在锁屏界面输入此 PIN 将触发紧急设备清除."},
    {"duress_pin_set_title", "设置胁迫 PIN"},
    {"duress_pin_success_desc", "在锁屏界面输入此 PIN 将清除设备数据."},
    {"duress_pin_success_title", "胁迫 PIN 已设置"},
    {"duress_pin_title", "胁迫 PIN"},
    {"duress_pin_verified_desc", "您输入的 PIN 与您的胁迫 PIN 匹配."},
    {"duress_pin_verified_title", "胁迫 PIN 已验证"},
    {"duress_pin_verify_desc", "输入您的胁迫 PIN 以确认您记得它."},
    {"duress_pin_verify_title", "验证胁迫 PIN"},
